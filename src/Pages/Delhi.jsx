...
function Delhi() {
  ...
  return (
    <div className="goa-page">
      ...
      <div
        className="hero"
        style={{ backgroundImage: `url(${delhiHero})` }}
      >
        <div className="overlay">
          <h1>Delhi Wedding 💍</h1>
          <p>Luxury • Grand • Elegant</p>
      ...
      <section className="venues">
        <h2>Top Wedding Venues in Delhi</h2>

        <div className="venue-cards">

          <div className="card">
            <img src={d1} alt="Leela Palace" />
            <div className="card-content">
              <h3>The Leela Palace</h3>
              <p>Luxury 5-star wedding venue</p>
              <div className="details">
                <span>⭐ 4.9</span>
                <span>👥 200-800 guests</span>
              </div>
          ...
          <div className="card">
            <img src={d2} alt="ITC Maurya" />
            <div className="card-content">
              <h3>ITC Maurya</h3>
              <p>Elegant banquet & luxury stay</p>
              <div className="details">
                <span>⭐ 4.8</span>
                <span>👥 150-700 guests</span>
              </div>
          ...
          <div className="card">
            <img src={d3} alt="Taj Palace" />
            <div className="card-content">
              <h3>Taj Palace</h3>
              <p>Grand wedding venue with luxury vibes</p>
              <div className="details">
                <span>⭐ 4.7</span>
                <span>👥 300-1000 guests</span>
              </div>
              <p className="price">₹28L - ₹75L</p>
            </div>
          </div>
      ...
      <section className="why">
        <h2>Why Choose Delhi?</h2>

        <div className="why-grid">

          <div className="why-card">
            <h3> Luxury Venues ✨</h3>
            <p>Delhi offers top-tier 5-star hotels and grand banquet halls.</p>
          </div>

          <div className="why-card">
            <h3> Perfect Connectivity 🚗</h3>
            <p>Well-connected city for guests from all over India and abroad.</p>
          </div>

          <div className="why-card">
            <h3> Grand Celebrations 🎉</h3>
            <p>Ideal for big fat Indian weddings with lavish arrangements.</p>
          </div>

          <div className="why-card">
            <h3> All-in-One Services 💼</h3>
            <p>Everything from decor to catering available at premium level.</p>
          </div>
